        ...
        >
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
            <View style={styles.header}>
              ...
              <Text style={styles.orderIdText}>Order #NB-{order._id.slice(-8).toUpperCase()}</Text>
            ...
            <View style={styles.summaryCard}>
              ...
              <View style={styles.methodRow}>
                <Badge label={order.paymentMethod} color={theme.colors.success} />
                <Badge label={order.fulfillmentMethod.toUpperCase()} color={theme.colors.primary} />
