      ...
      <Animated.View entering={FadeInUp.delay(index * 120).duration(600)}>
        <Card style={styles.card} variant="elevated">
          ...
          <View style={styles.actions}>
            ...
            <TouchableOpacity style={[styles.actionBtn, styles.rejectBtn]} onPress={() => onReject(item._id, 'shop')}>
    ...
    return (
      <Animated.View entering={FadeInUp.delay(index * 120).duration(600)}>
        <Card style={styles.card} variant="elevated">
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={[styles.actionBtn, styles.approveBtn]} onPress={() => handleApproveRider(item._id)}>
              <Icon name="checkmark-circle" size={18} color={theme.colors.white} />
              <Text style={styles.btnText}>View / Approve</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.actionBtn, styles.rejectBtn]} onPress={() => handleReject(item._id, 'rider')}>
              <Icon name="close-circle" size={18} color={theme.colors.danger} />
              <Text style={[styles.btnText, {color: theme.colors.danger}]}>Reject</Text>
            </TouchableOpacity>
          </View>
